...
| RFC-R8 | Salience fast-track, authority-qualified | Afferent U5/U6 | Repair plan so salience can fast-track modulation/proposal only, never semantic truth | `docs/plans/2026-06-30-001-feat-afferent-membrane-v1-plan.md` | Plan review; U6b `tests/test_u6b_experience_tick.py`; future active DynamicModulation tests |
