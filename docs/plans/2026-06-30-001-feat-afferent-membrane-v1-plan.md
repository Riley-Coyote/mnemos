...
path; those remain future U6/ExperienceTick work under the same RFC-R7/R8
boundary.
...
| RFC-R8 | Salience fast-track, authority-qualified | U5/U6, extended by U6c (dream graduation) | U5: `mnemos/store/sqlite_store.py::EngramStore.store_dynamic_modulation`, `mnemos/store/sqlite_store.py::write_proposal`; U6/ExperienceTick: planned `mnemos/affect/experience_tick.py`, planned `mnemos/affect/dynamic_modulation.py`, `mnemos/retrieval/reactive.py`, planned `mnemos/inner_life/narrative_gate.py`, planned `mnemos/dream_patterns/pattern_store.py` | U5 modulation/proposal storage tests proving salience cannot mint semantic truth by persistence alone; ExperienceTick and four-condition-conjunctive-gate tests remain planned |
...
| RFC-R8 | U5/U6, extended by U6c (dream graduation) | U5 actual: `mnemos/store/sqlite_store.py::EngramStore.store_dynamic_modulation`, `mnemos/store/sqlite_store.py::write_proposal`; U6 planned: planned `mnemos/affect/experience_tick.py::ExperienceTick`, planned `mnemos/affect/experience_tick.py::route_tick`, planned `mnemos/affect/dynamic_modulation.py::store_modulation`, `mnemos/retrieval/reactive.py::ReactiveRetriever.retrieve`, planned `mnemos/inner_life/narrative_gate.py::apply_high_blast_generated_drop`, planned `mnemos/dream_patterns/pattern_store.py::conjunctive_stabilization_gate` | U5 actual `tests/test_u5_inert_modulation.py::test_u5_rejects_evidentiary_authorities`; planned `tests/test_experience_tick.py::test_salience_fast_track_emits_bounded_modulation_or_proposal`; planned `tests/test_dream_graduation.py::test_authentic_recurrence_graduates_at_generated_authority` | U5 actual `tests/test_u5_inert_modulation.py::test_u5_check_constraints_hold_against_raw_sql`; planned `tests/test_experience_tick.py::test_high_salience_single_tick_cannot_mint_semantic_truth`; planned `tests/test_dynamic_modulation.py::test_modulation_cannot_write_belief_or_identity`; planned `tests/test_dream_graduation.py::test_stabilization_requires_all_four_conjunctive_conditions`; planned `tests/test_dream_graduation.py::test_vividness_ratio_cap_blocks_single_instance_domination`; planned `tests/test_dream_graduation.py::test_identity_domain_content_preempted_at_gate_transitions_recurring_to_decayed` |
...
| DynamicModulation lifecycle (`store_dynamic_modulation`, `get_dynamic_modulation`, `count_dynamic_modulations`, `delete_dynamic_modulations_by_rollout_tag`) | no operational read surface; rows are inert and never feed context, retrieval, salience, identity, consolidation, substrate, or MCP tools | no ordinary review surface; future ExperienceTick/proposal review must emit ProposalLedger rows rather than reading modulation rows as review prose | by-ID lifecycle inspection, integer counts, and normalized-tag backout only | ranked scans, joins against memory tables, context packet inclusion, belief/proposal evidence citation, recurrence promotion, identity authority, or any read that changes retrieval/salience |
...
| 7. DynamicModulation cannot be cited as evidence | U5 | `tests/test_u5_inert_modulation.py::test_u5_read_surfaces_byte_identical_with_and_without_modulations`; `tests/test_u5_inert_modulation.py::test_u5_rejects_evidentiary_authorities`; legacy planned `tests/test_dynamic_modulation.py::test_dynamic_modulation_cannot_be_cited_as_evidence` remains the higher-level U6/ExperienceTick phrasing |
| 8. DynamicModulation cannot promote by recurrence | U5 | `tests/test_u5_inert_modulation.py::test_u5_check_constraints_hold_against_raw_sql`; `tests/test_u5_inert_modulation.py::test_u5_no_module_reads_modulation_table_outside_sanctioned_files`; legacy planned `tests/test_dynamic_modulation.py::test_dynamic_modulation_cannot_promote_by_recurrence` remains the higher-level U6/ExperienceTick phrasing |
...
| 11. DynamicModulation cannot effect belief/identity write | U5/U6 | `tests/test_u5_inert_modulation.py::test_u5_same_store_before_after_modulation_insert_identical`; `tests/test_u5_inert_modulation.py::test_u5_sanctioned_files_contain_no_ranking_read_of_modulations`; planned `tests/test_dynamic_modulation.py::test_modulation_cannot_write_belief_or_identity`; planned `tests/test_experience_tick.py::test_high_salience_single_tick_cannot_mint_semantic_truth` |
